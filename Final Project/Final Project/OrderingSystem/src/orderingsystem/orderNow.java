...
public class orderNow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/orderingsystem/order_now_bcg.jpeg"))); // NOI18N

        jMenu1.setForeground(new java.awt.Color(190, 13, 241));
        jMenu1.setText("Order Now");
        jMenu1.setFont(new java.awt.Font("Phosphate", 0, 36)); // NOI18N

        jMenuItem1.setBackground(new java.awt.Color(153, 153, 153));
        jMenuItem1.setFont(new java.awt.Font("American Typewriter", 0, 18)); // NOI18N
        jMenuItem1.setForeground(new java.awt.Color(51, 51, 51));
        jMenuItem1.setText("Rice Village");
